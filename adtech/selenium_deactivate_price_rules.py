...
# from store_prebid_placements import placements_f as placements
    ...
    for i in range(1, 50):
        try:
            if browser.find_element_by_xpath(
                ...
                "/html/body/form/div[7]/div[4]/table/tbody/tr[" + str(i) + "]/td[4]/div/span").text != 'Expired':
...
def main_program(placements):
    ...
    for placement in placements:
        ...
        for i in range(21):
            try:
                browser.find_element_by_id("rulesFilternameValue")
                break
            except:
                time.sleep(1)
    browser.close()
